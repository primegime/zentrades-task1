    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 3:
          ...
          products = Object.values(response.data.products);
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 2:
          ...
          html = '<h1>Product List</h1><table><tr><th>Title</th><th>Price</th><th>Subcategory</th><th>Popularity</th></tr>';
          products.forEach(function (product) {
            html += "<tr><td>".concat(product.title, "</td><td>$").concat(product.price, "</td><td>").concat(product.subcategory, "</td><td> ").concat(product.popularity, "</td></tr>");
          });
          html += '</table>';
          res.send(html);
        case 7:
